...
- Wireless ADB target: `192.168.2.93:36057`
- Shell: `zsh`
...
```bash
"$HOME/Android/platform-tools/adb" connect 192.168.2.93:36057
"$HOME/Android/platform-tools/adb" -s 192.168.2.93:36057 install -r \
...
```bash
"$HOME/Android/platform-tools/adb" -s 192.168.2.93:36057 shell \
