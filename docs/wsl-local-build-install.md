...
- Wireless ADB target: `192.168.2.93:42979`
- Shell: `zsh`
...
```bash
"$HOME/Android/platform-tools/adb" connect 192.168.2.93:42979
"$HOME/Android/platform-tools/adb" -s 192.168.2.93:42979 install -r \
...
```bash
"$HOME/Android/platform-tools/adb" -s 192.168.2.93:42979 shell \
